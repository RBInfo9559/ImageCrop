...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                resources.getDrawable(R.drawable.croplib_camera_crop_width);
        mResizeDrawableHeight =
                resources.getDrawable(R.drawable.croplib_camera_crop_height);
        mResizeDrawableDiagonal =
                resources.getDrawable(R.drawable.croplib_indicator_autocrop);
    }
